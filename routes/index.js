...
router.get('/', function(req, res, next) {
  ...
  res.render('index', { id:id,from: global.address[0].address ,companyA: global.address[1].address, companyB: global.address[2].address,companyC: global.address[3].address});
});

router.get('/fromIndex', function(req, res, next) {
  res.render('fromIndex');
})
...
router.get('/getfromSend', function(req, res, next) {
  ...
  res.render('getfromSend',{info:info,companyA: global.address[1].address, companyB: global.address[2].address,companyC: global.address[3].address});
})
...
router.get('/select', function(req, res, next) {
  ...
  res.render('info',{trans:trans,from:global.address[0].address,list:list});
})
...
router.get('/getCompany', function(req, res, next) {
  ...
  res.render('company',{address:global.address[index].address,type:type});
})
...
router.get('/message', function(req, res, next) {
  ...
  res.render('note',{trans:trans,from:global.address[0].address,list:list,address:address});
})

router.get('/messageSuccess', function(req, res, next) {
  common.joinUndone(req.query.address);
  res.render("sign-success",{id:global.undone[0].id});
})
